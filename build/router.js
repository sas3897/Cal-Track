...
server.get("/adhoc", function (req, res) {
    if (is_logged_in(req)) {
        sqlite.getAllFoods(function (foods_list) {
...
server.get("/add_food", function (req, res) {
    res.render("add_food");
});
server.post("/add_food", function (req, res) {
...
server.post("/add_recipe", function (req, res) {
    sqlite.enterRecipe(req.body.recipe_name, req.body.foods, function () {
        //Success message
        res.json({ err: "" });
    }, function () {
...
server.post("/get_food", function (req, res) {
    sqlite.getFood(req.body.food_name, function (food_info) {
        res.send(food_info);
    });
});

...
server.post("/del_ingredient", function (req, res) {
    sqlite.delIngredient(req.body.ing_name, function (err) {
        if (err) {
            res.send({ status: "error" });
        }
        else {
...
server.post("/del_meal", function (req, res) {
    sqlite.delMeal(req.body.meal_id, function (err) {
        if (err) {
            res.send({ status: "error" });
        }
        else {
